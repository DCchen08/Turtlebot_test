...
trajectory = xlsread('trajectory_controller_1.xlsx');
...
while(color_num <= 20)
    ...
    legend_str{color_num} = ['Trajectory',num2str(color_num),'--Controller 1'];
...
hold on
rectangle('Position',[0.8 0.8 0.4 0.4],'EdgeColor','c','LineWidth',1)
hold on
...
frame = getframe(gcf); 
im = frame2im(frame); 
imwrite(im,'Trajectory_controller_1.png'); 
